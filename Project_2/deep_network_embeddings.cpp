/*
  ...
  This program is given a target image and uses the feature vector csv, ResNet18_olym.csv. 
  It then reads the feature vector file, computes the SSD based on the target, and identifies the top N matches.
*/
...
int main()
{
  std::cout << "Running the deep network embeddings task" << std::endl;
  // Init file locations
  std::string targetImage = "pic.0948.jpg";   // Test with pic.0893.jpg and pic.0164.jpg
